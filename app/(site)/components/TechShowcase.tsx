...
const technologies = [
    ...
    { name: "Nextjs", image: "/images/next.svg", description: "React framework for server-side rendering and static sites, Super Fast App!" },
    ...
    { name: "Coming Soon", image: "/images/coming.jpg", description: "Coming Soon!" },
  ];
  

const TechShowcase = () => {
  return (
    <div className="bg-gray-600 py-16 shadow-lg">
      ...
      <h2 className="text-center text-white text-2xl mb-8">
          Your E-commerce Website is Lighing Fast!!
      </h2>
